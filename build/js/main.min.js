...
window.addEventListener("DOMContentLoaded", function () {
  var taskHeader = document.querySelector(".task__header");
  var taskWrapper = document.querySelector(".task__wrapper");
  function checkScroll() {
    var scrollTop = taskWrapper.scrollTop;
    if (scrollTop > 0) {
  ...
  var calendarList = document.querySelectorAll(".task__inner--calendar");
  calendarList.forEach(function (e) {
    var btnCalendar = e.querySelector(".btn--calendar");
    var inputCalendar = e.querySelector(".custom-input--calendar");
    btnCalendar.addEventListener("click", function () {
      inputCalendar.showPicker();
    });
  });
  var selectElements = [document.getElementById("coordinating"), document.getElementById("responsible"), document.getElementById("group"), document.getElementById("open"), document.getElementById("create")];
